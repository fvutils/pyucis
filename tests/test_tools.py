...
class TestToolImplementations:
    ...
    def test_open_database_not_found(self):
    ...
    def test_list_databases_with_handles(self):
    ...
    def test_get_coverage_summary_no_db(self):
    ...
    def test_get_coverage_gaps_no_db(self):
    ...
    def test_get_covergroups_no_db(self):
    ...
    def test_get_hierarchy_no_db(self):
