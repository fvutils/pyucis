...
class TestMerge:
    ...
    def test_null_inst_cg_1_cp(self):
        ...
        assert len(rpt.covergroups[0].coverpoints) == 1
        assert len(rpt.covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].coverpoints[0].coverage == 100.0
        
        assert len(rpt.covergroups[0].covergroups) == 2
#        assert rpt.covergroups[0].name == "cvg"
        assert len(rpt.covergroups[0].covergroups[0].coverpoints) == 1
        assert len(rpt.covergroups[0].covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[0].coverpoints[0].coverage == 50.0
        
#        assert rpt.covergroups[0].name == "cvg"
        assert len(rpt.covergroups[0].covergroups[1].coverpoints) == 1
        assert len(rpt.covergroups[0].covergroups[1].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[1].coverpoints[0].coverage == 50.0
...
#        assert rpt.covergroups[0].name == "cvg"
    ...
    def test_2db_1t_1i(self):
        ...
        assert len(rpt.covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].coverpoints[0].coverage == 100.0
        assert len(rpt.covergroups[0].covergroups) == 1

        assert len(rpt.covergroups[0].covergroups[0].coverpoints) == 1
        assert len(rpt.covergroups[0].covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[0].coverpoints[0].coverage == 100.0
    ...
    def test_3db_2t_1i(self):
        ...
        assert rpt.covergroups[1].name == "cvg2"
        assert len(rpt.covergroups[1].covergroups) == 1
        assert len(rpt.covergroups[1].covergroups[0].coverpoints) == 1
        assert len(rpt.covergroups[1].covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[1].covergroups[0].coverpoints[0].coverage == 50.0
    ...
    def test_1db_2ci_2cp_1cr(self):
        ...
        assert len(rpt.covergroups[0].crosses[0].bins) == 4
        assert rpt.covergroups[0].crosses[0].coverage == 50.0
        
        assert len(rpt.covergroups[0].covergroups) == 2
#        assert rpt.covergroups[0].name == "cvg"
        assert len(rpt.covergroups[0].covergroups[0].coverpoints) == 2
        assert len(rpt.covergroups[0].covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[0].coverpoints[0].coverage == 50.0
        assert len(rpt.covergroups[0].covergroups[0].coverpoints[1].bins) == 2
        assert rpt.covergroups[0].covergroups[0].coverpoints[1].coverage == 50.0
        assert len(rpt.covergroups[0].covergroups[0].crosses) == 1
        assert len(rpt.covergroups[0].covergroups[0].crosses[0].bins) == 4
        assert round(rpt.covergroups[0].covergroups[0].crosses[0].coverage, 2) == 25.0
        
#        assert rpt.covergroups[0].name == "cvg"
        assert len(rpt.covergroups[0].covergroups[1].coverpoints) == 2
        assert len(rpt.covergroups[0].covergroups[1].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[1].coverpoints[0].coverage == 50.0
  ...
  <instanceCoverages name="cg_inst" key="0">
    ...
    <covergroupCoverage>
      <cgInstance name="L1ClientOp" key="0">
        ...
        assert len(dst_db.m_children) == 2
        assert len(dst_db.m_children[1].m_children[0].m_children) == 4
        assert len(dst_db.m_children[1].m_children[0].m_children[2].coverpoints) == 2
        assert len(dst_db.m_children[1].m_children[0].m_children[3].m_children[2].coverpoints) == 2
...
#        formatter.report()
        ...
        assert rpt.covergroups[0].coverpoints[0].coverage == 100.0
        assert len(rpt.covergroups[0].crosses) == 1
        assert rpt.covergroups[0].crosses[0].coverage == 100.0

        # inst1
        assert len(rpt.covergroups[0].covergroups) == 2
        assert rpt.covergroups[0].covergroups[0].name == "inst1"
        assert len(rpt.covergroups[0].covergroups[0].coverpoints) == 2
        assert len(rpt.covergroups[0].covergroups[0].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[0].coverpoints[0].coverage == 100.0
        assert rpt.covergroups[0].covergroups[0].coverpoints[1].coverage == 50.0
        assert len(rpt.covergroups[0].covergroups[0].crosses) == 1
        assert rpt.covergroups[0].covergroups[0].crosses[0].coverage == 50.0
        
        assert len(rpt.covergroups[0].covergroups[1].coverpoints) == 2
        assert len(rpt.covergroups[0].covergroups[1].coverpoints[0].bins) == 2
        assert rpt.covergroups[0].covergroups[1].coverpoints[0].coverage == 100.0
