...
* :doc:`coverage_report_api` - Coverage report data structure
* :doc:`coverage_report_json` - JSON format specification
* :doc:`xml_interchange` - XML format for interchange
* :doc:`yaml_coverage` - YAML human-readable format
